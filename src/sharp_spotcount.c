/* Counts the number of sunspots within a region, separated by polarities, 
 * by using thresholding and counting the number of umbra via a connected
 * component labeling scheme. 
 * 
 * 
 * Changelog:		
 * 			
 * 			2014.03.30		--		First version of this code.
 * 
 * 			2014.06.08		--		Numerous undocumented changes made.
 * 									New: added rejection based upon QUALITY keyword.
 * 
...
char *module_name="sharp_spotcount";
char *module_desc="determines the number of sunspots within an active region by using SHARPs data. Outputs data to ARnumber.count.dat.";
char *version_id="1.0";
